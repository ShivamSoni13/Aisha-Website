...
import faq from "../assets/Images/About Aisha.png";
...
const faqs = [
  {
    q: "Who is the ideal candidate for Smilers?",
    a: "Smilers are suitable for most people with mild to moderate teeth misalignment or spacing issues. During your free consultation, Dr. Aisha will assess your suitability and recommend the best treatment plan for you."
  },
  {
  ...
  },
  {
    ...
    a: "Smilers are suitable for teenagers and adults. They are particularly popular with adults who want a discreet way to straighten their teeth without the look of traditional metal braces."
  },
  {
    q: "Are Smilers better than other types of orthodontics or braces?",
    a: "Smilers offer many advantages over traditional braces — they are virtually invisible, removable, and more comfortable. However, the best treatment depends on your individual case, which we'll assess at your free consultation."
  },
  {
    q: "Is the £25 deposit refundable?",
    a: "Yes, the £25 deposit to secure your Open Day appointment is fully refundable if you decide not to proceed with treatment after your consultation."
  },
  {
    q: "How long does treatment take?",
    a: "Treatment time varies depending on complexity. Most Smilers treatments take between 6 and 18 months. Your personalised treatment plan will include a clear timeline from day one."
  },
]
