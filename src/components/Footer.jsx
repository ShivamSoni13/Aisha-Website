        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 36, marginBottom: 44 }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontWeight: 300, fontSize: 13, color: "rgba(255,255,255,0.4)", lineHeight: 1.7, maxWidth: 200, marginBottom: 14 }}>
              Smile Dental Care, Brewers Lane, Gosport PO13 0JY
            </p>
          ...
          <div>
            ...
            {["About Us","Meet Dr. Aisha","Open Days","Contact Us","Careers"].map(t => (
              <a key={t} href="#" style={fLink} onMouseEnter={e=>e.target.style.color="var(--brand-light)"} onMouseLeave={e=>e.target.style.color="rgba(255,255,255,0.4)"}>{t}</a>
            ))}
          </div>
         ...
         <div style={{ minWidth: 300}}>
            ...
            <a href="https://calendly.com/booksmiledentalcare/clear-aligners-open-day-sat-4th-july-with-dr-aisha" style={{ display: "inline-block", background: "var(--brand)", color: "white", padding: "10px 20px", borderRadius: "var(--r-pill)", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13, textDecoration: "none" }}>Book Online →</a>
          </div>
        </div> 
