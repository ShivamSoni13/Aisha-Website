      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", height: 62, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div className="desk-nav" style={{ display: "flex", gap: 2, alignItems: "center" }}>
            ...
            <a href="https://calendly.com/booksmiledentalcare/clear-aligners-open-day-sat-4th-july-with-dr-aisha" style={{ marginLeft: 8, background: "var(--brand)", color: "white", padding: "9px 20px", borderRadius: "var(--r-pill)", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 14, textDecoration: "none", transition: "background 0.15s", whiteSpace: "nowrap" }}
