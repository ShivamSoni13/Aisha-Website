  ...
  const reviews = [
    {
      ...
      location: "Fareham",
      rating: 5,
      text: "I had been thinking about straightening my teeth for years but kept putting it off. Dr. Aisha made the whole process feel simple and stress-free. I'm so pleased with how my smile has turned out.",
      treatment: "Smilers"
    },
    {
      name: "Michael P.",
      ...
      rating: 5,
      text: "Really happy with the care I've received. The aligners were easy to wear and the team checked in regularly throughout my treatment. I'd definitely recommend Dr. Aisha to anyone considering teeth straightening.",
      treatment: "Smilers"
    },
    {
      name: "Sonia K.",
      location: "Portsmouth",
      rating: 5,
      text: "The results have been better than I expected. My teeth look much straighter and I feel far more confident smiling in photos. Thank you to Dr. Aisha and the team for all their support.",
      treatment: "Smilers"
    },
  ]
